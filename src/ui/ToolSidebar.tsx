...
import { canvasTools, FAMILY_LABEL, LINK_TOOL, toolId, type ToolDef } from "./canvas/kinds/registry"
...
/** Gli strumenti del canvas in colonna, a sinistra: Seleziona, gli strumenti di ogni famiglia in gruppi, e Collega. */
