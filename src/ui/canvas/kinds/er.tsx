...
import { addAttribute, moveAttribute, removeAttribute, updateAttribute, updateRelationship } from "@/editor/commands/er"
...
/**
 * Corpo del pannello proprietà per l'ER. La cornice (`PropertiesPanel`) monta questo componente
 * solo quando la selezione è esattamente un'entità o esattamente una relazione: qui basta
 * distinguere quale delle due, con la `key` che forza il remount quando cambia la selezione
 * (gli input sotto sono scontrollati, e senza remount terrebbero il valore dell'entità
 * precedente finché non arriva un altro evento).
 */
function Properties() {
